...
export const createApplication = asyncHandler(async (req, res, next) => {
    ...
    res.status(200).json(new APIResponse(200, application, "Application Created Successfully"));
...
export const employerGetAllApplications = asyncHandler(async (req, res, next) => {
    ...
    res.status(200).json(new APIResponse(200, applications, "Fetched All Applications Successfully."))
...
export const jobseekerDeleteApplication = asyncHandler(async (req, res, next) => {
    ...
    res.status(200).json(new APIResponse(200, application, "Application Deleted Successfully."))
